    ...
    def _monitor(self):
        while True:
            ...
            self.dataset2 = self.dataset2.append({'SPI': self.spi, 'AFSF': self.afsf, 'ADN': self.adn,
                                                 ...
                                                 'Ns': self.sw_num, 'PPR': ppr, 'PPD': ppd, 'label': '1'}, ignore_index=True)
            self.dataset2.to_csv('ref_time_test.csv', mode='a', header=False)
